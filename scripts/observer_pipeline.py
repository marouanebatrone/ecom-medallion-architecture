...
class ObserverPipeline:
    ...
    def fetch_tests(self):
        ...
        df = self.spark.read.jdbc(self.observers_db, "(SELECT * FROM observers WHERE is_active = true) as t", properties=self.properties)
        return df.collect()
    ...
    def log_incidents(self):
        ...
        if incident_count > 0:
            ...
            incidents_to_write.write.jdbc(self.observers_db, "incidents", "append", self.properties)
