...
class MedallionPipeline:
    ...
    def __init__(self):
        ...
        self.spark = SparkSession.builder \
            ...
            .config("spark.openlineage.capturedProperties", "spark.master,spark.app.name,spark.sql.shuffle.partitions,spark.executor.memory,spark.executor.cores,spark.driver.memory") \
            .getOrCreate()
    ...
    def silver_to_gold(self):
        ...
        print("Waiting a moment for lineage events to flush...")
        time.sleep(2)
        self.spark.stop()